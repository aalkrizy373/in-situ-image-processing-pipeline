# -*- coding: utf-8 -*-
"""Decon_1_channel.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mng1HhP9XUf2FRwd1OgtoRg1nWPigcYb
...
"""# Step 3 : Check if Single Channel"""
...
"""#Step 4: Preform Decon for each channel"""
...
"""#Save and download decon image"""

resultant=resultant.astype('uint16')#type casting result

io.imsave('image.tif', resultant)#saving image

files.download('image.tif')#download image